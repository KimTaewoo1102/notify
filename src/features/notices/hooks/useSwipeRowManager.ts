...
import type { SwipeableNoticeRowHandle } from '../components/SwipeableNoticeRow';
 ...
 *
 *  - `registerHandle(id, handle)` — `<SwipeableNoticeRow ref={...} />` 에서 호출.
 *    null 이면 unmount 정리.
 ...
 */
export function useSwipeRowManager() {
    ...
    const registerHandle = useCallback(
        (id: ID, handle: SwipeableNoticeRowHandle | null) => {
...
export type SwipeRowManager = ReturnType<typeof useSwipeRowManager>;
